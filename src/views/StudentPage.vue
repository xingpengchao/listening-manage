<template>
  <div class="container">
    <div class="handle-box">
      ...
      <el-button type="primary" @open="resetForm" @click="clickAddStudentButton">添加学生</el-button>
    </div>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      clickViewPersonalMaterialButton(sid){
         this.getPersonalMessageListByStudentNumber(sid)
      ...
      getTableData(searchKey = '' ){
        ...
        console.log(requestData)
          console.log("0909")
        this.getStudentList(requestData)
            .then(res => {
                console.log(res)
